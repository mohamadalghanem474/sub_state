...
abstract class SubState<TSuccess> with _$SubState<TSuccess> {
  ...
  const factory SubState.loading({@Default(0.0) double progress}) = _SubLoading;
  ...
  String? get errorOrNull => whenOrNull(failure: (err, show) => err);
  bool get showError => whenOrNull(failure: (err, show) => show) ?? false;
}
...
abstract class SubState2<T1, T2> with _$SubState2<T1, T2> {
  ...
  const factory SubState2.loading({@Default(0.0) double progress}) = _Sub2Loading;
...
abstract class SubState3<T1, T2, T3> with _$SubState3<T1, T2, T3> {
  ...
  const factory SubState3.loading({@Default(0.0) double progress}) = _Sub3Loading;
...
abstract class SubState4<T1, T2, T3, T4> with _$SubState4<T1, T2, T3, T4> {
  ...
  const factory SubState4.loading({@Default(0.0) double progress}) = _Sub4Loading;
...
abstract class SubState5<T1, T2, T3, T4, T5> with _$SubState5<T1, T2, T3, T4, T5> {
  ...
  const factory SubState5.loading({@Default(0.0) double progress}) = _Sub5Loading;
